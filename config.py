...
VocabPath = 'checkpoint/t3/vocab.txt'

# ## mlm模型文件路径 ## #
SourcePath = 'data/corpus/all_data1.txt'
# CorpusPath = 'data/test_data/test1.txt'
# CorpusPath = 'data/corpus/all_data.txt'
CorpusPath = 'data/train_data/train1.txt'
TestPath = 'data/train_data/test.txt'
# TestPath = 'data/test_data/test1.txt'
...
BatchSize = 16
SentenceLength = 16
# FinetunePath = 'checkpoint/pretrain_model/mlm_trained_alldata_len_16.model'
FinetunePath = 'checkpoint/t3/gs203412.pkl'
# ## MLM训练调试参数结束 ## #
